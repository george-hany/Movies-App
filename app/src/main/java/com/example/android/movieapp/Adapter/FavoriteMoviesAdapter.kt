...
class FavoriteMoviesAdapter( con:Context, val clickListener: (MovieTable) -> Unit) : RecyclerView.Adapter<FavoriteMoviesAdapter.Holder>(){
    var movies:List<MovieTable> = emptyList()
    ...
    internal fun setWords(movies: List<MovieTable>) {
        this.movies = movies
    ...
    class Holder(view:View) :RecyclerView.ViewHolder(view) {
        ...
        fun bind(part: MovieTable, clickListener: (MovieTable) -> Unit) {
